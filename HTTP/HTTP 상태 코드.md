...
목차[들어가며](https://joshua1988.github.io/web-development/http-part1/#들어가며)[HTTP 프로토콜이란?](https://joshua1988.github.io/web-development/http-part1/#http-프로토콜이란)[HTTP 프로토콜 특징](https://joshua1988.github.io/web-development/http-part1/#http-프로토콜-특징)[HTTP Request & HTTP Response](https://joshua1988.github.io/web-development/http-part1/#http-request--http-response)[URL](https://joshua1988.github.io/web-development/http-part1/#url)[HTTP 요청 메서드](https://joshua1988.github.io/web-development/http-part1/#http-요청-메서드)[HTTP 상태 코드](https://joshua1988.github.io/web-development/http-part1/#http-상태-코드)[다시 살펴보는 HTTP 요청과 응답](https://joshua1988.github.io/web-development/http-part1/#다시-살펴보는-http-요청과-응답)[마무리](https://joshua1988.github.io/web-development/http-part1/#마무리)
...
- 404 : Not Found, 서버가 요청한 URL을 찾을 수 없음을 알려주기 위해 사용한다. (출처 :https://feel5ny.github.io/2019/08/17/HTTP_003_03/)
...
- 상태 코드는 3자리 숫자로 만들어져 있으며 첫 번째 자리는 1에서 5까지 제공
  첫 번째 자리가 4와 5인 경우는 정상적인 상황이 아니라는 것을 나타내기 때문에 사이트 관리자가 즉시 알아야 하는 정보이다.
...
출처 : https://brunch.co.kr/@leedongins/65
